...
/**
 * v3 reel. Wide bodies, no nostril lenses, even orbits.
 * Keep ids so the chapter book still keys.
 */
export const SHOTS = [
  {
  ...
  {
    id: 'approach', duration: 10, fov: [48, 46], ease: 'easeInOut', tension: 0.28,
  ...
  {
    id: 'plumber', duration: 8, fov: [40, 36], ease: 'easeInOut', tension: 0.26,
  ...
  {
    id: 'well', duration: 8, fov: [46, 42], ease: 'easeInOut', tension: 0.3,
    path: [v(-4.2, 3.8, KEEP_Z + 2), v(4.4, 5.0, KEEP_Z - 3), v(0.2, 7.4, KEEP_Z - 6), v(-2.2, 4.6, KEEP_Z + 1)],
    look: [v(0, 3.4, KEEP_Z + 3), v(0.3, 5.5, KEEP_Z + 4), v(0, 10.5, doorZ), v(0, 4.2, KEEP_Z + 3)],
  },
  {
    id: 'ascent', duration: 10, fov: [48, 52], ease: 'easeInOut', tension: 0.24,
  ...
  {
    id: 'storm', duration: 12, fov: [52, 46], ease: 'easeInOut', tension: 0.22,
  ...
  {
    id: 'circuit', duration: 10, fov: [44, 44], ease: 'linear', tension: 0.2, closed: true,
    path: circuit.path,
    look: circuit.look,
  },
  {
    id: 'night', duration: 10, fov: [42, 40], ease: 'easeInOut', tension: 0.28,
  ...
  {
    id: 'welcome', duration: 8, fov: [46, 48], ease: 'easeInOut', tension: 0.26,
    path: [v(8.5, 5.4, 36), v(5.2, 4.2, 30), v(2.6, 3.4, 26), v(1.2, 3.0, 22)],
    look: [v(0, 10, KEEP_Z + 6), v(0, 9.2, KEEP_Z + 4), v(0, 8.4, KEEP_Z + 2), v(0.2, 2.0, 16.5)],
  },
  {
    id: 'endcard', duration: 8, fov: [44, 40], ease: 'easeInOut', tension: 0.25,
