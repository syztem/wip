...
function stillWater() {
  const material = new THREE.MeshPhysicalMaterial({
    color: 0x1a6f88, roughness: 0.16, metalness: 0.06,
    transparent: true, opacity: 0.9, transmission: 0.22, thickness: 0.55, ior: 1.333,
  });
...
export function createWater({ nodes = true } = {}) {
  ...
  const material = new THREE.MeshStandardNodeMaterial({ color: '#1a6f88', roughness: 0.12, metalness: 0.08 });
