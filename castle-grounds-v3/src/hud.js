...
export function createHud() {
  ...
  root.innerHTML = `
    ...
    <div class="chrome top">
      <div class="brand">
        <span class="mark">CGX</span>
        <span class="prod">CASTLE GROUNDS EXTREME</span>
      </div>
      <div class="clock">
    ...
    <div class="card">
      <div class="kicker"><span data-n>00</span> · <span data-kicker>ULTRA PRESET</span></div>
      <div class="title" data-title>CASTLE GROUNDS</div>
  ...
  return {
    tick({ dt, reelT, shotId, hours, weather, backend, bloom, flash }) {
      ...
      el.ticker.textContent =
        `${fps} FPS  ·  ${backend}  ·  ${bloom ? 'BLOOM ON' : 'RAW'}  ·  LOOP ${u.toFixed(1)} / ${LOOP}.0`;
