...
export const SHOTS = [
  ...
  {
    id: 'bridge', duration: 10, fov: [56, 46], ease: 'smoothstep',
    path: [v(-4.2, 1.35, 8), v(-1.6, 1.7, 2), v(0.15, 2.15, -8), v(0.2, 2.55, doorZ + 3.2)],
    look: [v(0, 7, KEEP_Z + 8), v(0, 8.5, KEEP_Z + 4), v(0, 10, doorZ), v(0, 11.5, KEEP_Z + 2)],
  },
  {
  ...
  {
    id: 'well', duration: 8, fov: [50, 40], ease: 'easeInOut',
    path: [v(-2.4, 5.0, KEEP_Z - 2), v(2.6, 6.8, KEEP_Z - 5), v(-1.8, 8.4, KEEP_Z - 6.5), v(0.3, 7.2, KEEP_Z - 3)],
    look: [v(0, 11.5, doorZ), v(0.4, 12.2, doorZ), v(0, 12.8, doorZ), v(0, 12.0, doorZ)],
  },
  {
  ...
  {
    id: 'night', duration: 10, fov: [46, 38], ease: 'smoothstep',
    path: [v(-8, 2.2, 22), v(-4, 1.9, 18), v(2.5, 1.7, 14), v(6, 2.4, 10)],
    look: [v(-2, 1.4, 16), v(0, 1.6, 14), v(1.5, 1.8, 12), v(0, 3.2, KEEP_Z + 20)],
  },
  {
